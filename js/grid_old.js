...
// $.ajax({
        ...
        // type : "POST",
//         
       // url : 'services/adj_get_thambnails.php',
// 
           ...
           // total_count=response.total_count;
              // //  alert(total_count);
                ...
                // var rec_s= new Array();
                    ...
                    // {
//                        
                // ax+= '<div class="bb-item"><a href="#"><img src="'+response.data[i].thumb_img_url+'" alt="image01"/></a></div>' ;       
                    // } 
                    // pl=ax;
...
// }
 // alert(cc)
// var cc='<div class="main clearfix">'+
                // '<div class="bb-custom-wrapper">'+
                    // '<div id="bb-bookblock" class="bb-bookblock">'+
                       // pl+
               // // this.$sliderUl=             $(
...
//                 
            ...
            // }, this ), 3000 );
                        	//alert(2);
                 // jQuery("div").slideDown("slow").delay(3000);
                     //jQuery("div").slideDown("slow").delay(3000).slideUp("slow");
                   //  alert(total_count) 
             // alert('create');
...
//});
  ...
  this.iml(cc);   	
    ...
    iml : function(cc){
            ...
            this.$sliderUl= $( '<div class="main clearfix">' );
