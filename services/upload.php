...
// echo "string";
// echo $site_owner_id;
 $pathname='../uploads/images/'.$site_owner_id.'/';
$pathname_chk='uploads/images/'.$site_owner_id.'/';
$_REQUEST['img_malti']=$_REQUEST['multiVal'];
...
$image_url=$pathname_chk.$_FILES['upl']['name'];
$created_by=1;
$param=array();
...
if(isset($_FILES['upl']) && $_FILES['upl']['error'] == 0){
	...
	if(move_uploaded_file($_FILES['upl']['tmp_name'], $pathname.$_FILES['upl']['name'])){
		// echo '{"status":"success"}';
		// exit;
			$results=array();
