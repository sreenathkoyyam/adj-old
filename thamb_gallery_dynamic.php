...
//           
        ...
        $.ajax({
               type: "POST",
               dataType: "json",
               url: "services/adj_delete_thumb_photo_gallery.php",
               data : {
               ...
               success: function(data){
                    if(data)
                    {
                        window.location.reload('thamb_gallery_dynamic.php');
                    }
                }
        });
        // }
                    ...
                    <div class="reg" style="width:100%;  margin: 0 auto;font-size:13px !important;">
                       ...
                       <form action="" method="post">
                        ...
                        <div id="img_table" class="container">
                          ...
                          require_once( "services/adj_get_thambnails.php" );
                            ...
                            foreach ($result['data'] as $par) {
                                ...
                                $pathname1=$par['thumb_img_url'];
						        $file_id=$par['brand_category_map_id'];
								//echo $file_id;
